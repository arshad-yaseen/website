// Generates the SVG loader components in src/components/dot-matrix.
...
const OUT = join(dirname(fileURLToPath(import.meta.url)), "../src/components/dot-matrix");
...
import type { LoaderProps } from "@fyi/ui/types/loader-props";
